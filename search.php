...
<?php if (have_posts()) : ?>
	...
	<header class="search-results-header txt-center">
		<h1 class="search-results-title">
			<?php echo function_exists('pll__') ? pll__('Resultados') : ''; ?> "<?php echo get_search_query(); ?>"
		</h1>
...
?>
	<header class="search-results-header txt-center">
		<h1 class="search-results-title"><?php echo function_exists('pll__') ? pll__('Sin resultados') : ''; ?></h1>
	</header>
<?php
endif;
?>
